...
# Project paths
# __file__ is in src/, so parent.parent gets us to the project root
...
# Predictions below this threshold will be rejected as "Unknown"
# Recommended: 0.60 for balanced accuracy/rejection, 0.70 for higher precision
RECOGNITION_CONFIDENCE_THRESHOLD = float(os.getenv("RECOGNITION_CONFIDENCE_THRESHOLD", "0.60"))
